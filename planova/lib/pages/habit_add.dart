...
class _HabitAddPageState extends State<HabitAddPage> {
  ...
  void _addHabit() async {
    ...
    if (user != null) {
      Map<String, dynamic> habitData = {
        ...
        'start_date': Timestamp.fromDate(DateFormat('yyyy-MM-dd').parse(_startDateController.text)),
        'end_date': Timestamp.fromDate(DateFormat('yyyy-MM-dd').parse(_endDateController.text)),
      ...
      FirebaseFirestore.instance.collection('habits').add(habitData).then((value) {
  ...
  void _selectDate(BuildContext context, TextEditingController controller, {DateTime? firstDate}) async {
